        ...
        <div className="notifications-wrapper">
            ...
            <div className="card notification text-center">
                <div className="card-body">
                    <h5 className="card-title">El <Link to="/refugios/1">Refugio San Pedro</Link> ha respondido tu solicitud de adopción (Nº 150)</h5>
            ...
            <div className="card notification text-center">
                <div className="card-body">
                    ...
                    <p className="card-text pt-2">Has confirmado tu asistencia para visitar el <Link to="/refugios/1">Refugio San Pedro</Link> en la siguiente fecha:</p>
                    <p><b>20/11/2022 a las 12:00 hs.</b></p>
                </div>
