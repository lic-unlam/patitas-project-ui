...
import { veterinariaFormParameters } from "./parametros/veterinariaFormParameters";
...
export const VeterinariaForm = (props) => {
    ...
    const registrarVeterinaria = async (values, formikBag) => {
        try {
            const response = await fetch("https://localhost:7277/api/auth/registro/veterinaria", {
                method: "POST",
                headers: {
    ...
    return (
        <Formik
        initialValues={veterinariaFormParameters.initialValues}
        validationSchema={veterinariaFormParameters.validations}
        onSubmit={registrarVeterinaria}
        >
            ...
            <form id="register_form" onSubmit={handleSubmit}>
                ...
                <div className="form-floating py-2">
                    ...
                    { errors.especialidades && touched.especialidades && <AuthFormErrorMessage field={errors.especialidades} /> }
                </div>
                <div className="form-floating py-2">
                    <input
                        type="date"
                    ...
                    { errors.fechaFundacion && touched.fechaFundacion && <AuthFormErrorMessage field={errors.fechaFundacion} /> }
                </div>
                <div className="form-floating py-2">
                    <input
                        type="text"
                ...
                <div className="form-floating py-2">
                    ...
                    { errors.telefonoAlternativo && touched.telefonoAlternativo && <AuthFormErrorMessage field={errors.telefonoAlternativo} /> }
                </div>
                <div className="py-2">
                    <div className="row">
                        <div className="col-6">
