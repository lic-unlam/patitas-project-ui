...
export const RefugioForm = (props) => {
    ...
    return (
        <>
            ...
            <div className="py-2">
                <input type="text" className="form-control" placeholder="Nombre del refugio"/>
            </div>
            <div className="py-2">
                <input type="text" className="form-control" placeholder="Razón social"/>
            </div>
            <div className="py-2">
                <input type="text" className="form-control" placeholder="Nombre del responsable a cargo"/>
            </div>
            <div className="py-2">
                <input type="text" className="form-control" placeholder="Apellido del responsable a cargo"/>
            </div>
            <div className="py-2">
